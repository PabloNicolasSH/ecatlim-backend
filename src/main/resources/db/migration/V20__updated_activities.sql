...
ALTER TABLE survey_response ADD attempt_number INT;
ALTER TABLE survey_response ADD response_value VARCHAR(255);

ALTER TABLE activity ADD creator_id INT;
ALTER TABLE activity ADD lesson_block_id INT;
...
ALTER TABLE activity_correctors ADD CONSTRAINT fk_actcor_on_activity FOREIGN KEY (activity_id) REFERENCES activity (id);
...
ALTER TABLE activity_progress MODIFY activity_id INT NOT NULL;